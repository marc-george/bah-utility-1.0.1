...
gulp.task('rename-application', function (callback) {
  gulpSequence('replace-seed-files', 'replace-root-seed-files', 'delete-seed-files')(callback);
});
...
gulp.task('docs', function (callback) {
  gulpSequence('clean', 'lint', 'serve:docs')(callback);
});

gulp.task('default', function (callback) {
  gulpSequence('clean', 'lint', 'serve:dev')(callback);
});
